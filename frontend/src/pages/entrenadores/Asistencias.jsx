      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6 space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <button className="mt-4 bg-club-blue hover:bg-blue-800 text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition-all shadow-md hover:shadow-lg">
              Subir asistencia
            </button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            {mockAsistencias.map((a, i) => (
              <div key={a.id} className={`flex items-center gap-3 py-3 ${i < mockAsistencias.length - 1 ? "border-b border-gray-100" : ""}`}>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 text-xs mt-0.5">Cargado: {a.fecha} · Rojo 2025</p>
                </div>
